module NavigationHelper
  def conversation_header_partial_path(conversation)
    #επιστρέφεται το κατάλληλο partial για ιδιωτική ή ομαδική συνομιλία
  ...
  def collapsible_links_partial_path
    #επιστρέφεται το κατάλληλο partial ανάλογα με το αν είναι συνδεδεμένος
    if user_signed_in?
  ...
  def nav_header_content_partials
    partials = []
    #στη σελίδα messenger εμφανίζεται διαφορετικό header
  ...
  def nav_contact_requests_partial_path
    #εμφανίζεται διαφορετικό partial αν υπάρχουν αιτήματα επαφής
